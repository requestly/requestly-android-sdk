...
package io.requestly.android.core.modules.logs.lib.lynx.main.model;
...
import io.requestly.android.core.modules.logs.lib.lynx.main.exception.IllegalTraceException;
...
public class Lynx {
  ...
  public Lynx(Logcat logcat, MainThread mainThread, TimeProvider timeProvider) {
    ...
    setFilters();
    // Clear Stream when init first time
    // Should we clear this? If we clear this, then the crashes won't show up
    clearStream();
  }

    public void clearStream() {
      // Moving this in logcat was having weird effect due to thread implementation
        try {
            // Hack to clear stream after restart
            // TODO: Ideally this should run on app death
            Runtime.getRuntime().exec("logcat -c");
//            Log.d(": cleared", "Logcat Cleared");
        } catch (IOException e) {
