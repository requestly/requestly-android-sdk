...
import io.requestly.android.okhttp.util.HarTestUtils.createSingleTransactionHar
...
public class HarTest {
    ...
    public fun `har is created correctly with creator`() {
        val har = context.createSingleTransactionHar("GET")
        val creator = Creator(
            context.getString(R.string.rq_interceptor_name),
            context.getString(R.string.rq_interceptor_version),
        )
