...
import io.requestly.android.okhttp.internal.data.har.log.Entry
import io.requestly.android.okhttp.internal.data.har.log.entry.Request
import io.requestly.android.okhttp.internal.data.har.log.entry.Response
import io.requestly.android.okhttp.internal.data.har.log.entry.request.PostData
import io.requestly.android.okhttp.internal.data.har.log.entry.response.Content
...
internal object HarTestUtils {
    ...
    internal fun Context.createSingleTransactionHar(method: String): Har {
        return HarUtils.fromHttpTransactions(
            ...
            Creator(getString(R.string.rq_interceptor_name), getString(R.string.rq_interceptor_version))
        )
    }
