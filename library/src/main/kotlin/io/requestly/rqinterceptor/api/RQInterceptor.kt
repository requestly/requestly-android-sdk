...
import io.requestly.rqinterceptor.internal.support.CacheDirectoryProvider
import io.requestly.rqinterceptor.internal.support.PlainTextDecoder
import io.requestly.rqinterceptor.internal.support.RequestProcessor
import io.requestly.rqinterceptor.internal.support.ResponseProcessor
...
//        request = requestProcessor.process(request, transaction)
    ...
    public class Builder(internal var context: Context) {
         ...
         * the decoders.
         */
        public fun addBodyDecoder(decoder: io.requestly.rqinterceptor.api.BodyDecoder): Builder = apply {
