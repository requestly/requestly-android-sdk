...
import io.requestly.rqinterceptor.util.ChuckerInterceptorDelegate
import io.requestly.rqinterceptor.util.ClientFactory
import io.requestly.rqinterceptor.util.NoLoggerRule
import io.requestly.rqinterceptor.util.readByteStringBody
import io.requestly.rqinterceptor.util.toServerRequest
...
internal class ChuckerInterceptorDecodingTest {
    ...
    private class LiteralBodyDecoder : io.requestly.rqinterceptor.api.BodyDecoder {
    ...
    private class ReversingDecoder : io.requestly.rqinterceptor.api.BodyDecoder {
    ...
    private class NoOpDecoder : io.requestly.rqinterceptor.api.BodyDecoder {
    ...
    private class IoThrowingDecoder : io.requestly.rqinterceptor.api.BodyDecoder {
    ...
    private class StatefulDecoder : io.requestly.rqinterceptor.api.BodyDecoder {
